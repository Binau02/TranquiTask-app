...
import tranquitaskstudio.project.tranquitaskapp.adapter.LeaderboardRowAdapter
import tranquitaskstudio.project.tranquitaskapp.data.FriendsModel
import tranquitaskstudio.project.tranquitaskapp.data.LeaderboardModel
...
class Leaderboard : Fragment() {
    ...
    private fun setLeaderboard() {
        ...
        if (activity != null) { // Vérifier la validité de l'activité
            ...
            rv.adapter = LeaderboardRowAdapter(
                leaderboard[globalCategories[categorieIndex].second] ?: listOf(), this
            ) { userRef ->
