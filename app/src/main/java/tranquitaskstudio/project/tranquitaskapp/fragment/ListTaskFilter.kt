...
//                radioButton.isChecked = true
        ...
        radioButtonCategory.buttonTintList = ColorStateList.valueOf(ContextCompat.getColor(requireContext(), R.color.black)) // Définit la couleur de teinte du bouton radio
...
//                radioButton.isChecked = true
        ...
        radioButtonPriority.buttonTintList = ColorStateList.valueOf(ContextCompat.getColor(requireContext(), R.color.black)) // Définit la couleur de teinte du bouton radio
